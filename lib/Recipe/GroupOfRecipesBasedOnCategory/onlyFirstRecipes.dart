...
class OnlyFirstRecipes extends StatefulWidget {
  @override
  _OnlyFirstRecipesState createState() => _OnlyFirstRecipesState();
}

class _OnlyFirstRecipesState extends State<OnlyFirstRecipes> {
  bool isLoaded = false;
