...
class OnlySecondRecipes extends StatefulWidget {
  @override
  _OnlySecondRecipesState createState() => _OnlySecondRecipesState();
}

class _OnlySecondRecipesState extends State<OnlySecondRecipes> {
  bool isLoaded = false;
